...
- Your **IP address**, included in the internal notification email our team receives about your inquiry. It is not stored in our systems and is not used to track you across the site; it exists so we can identify and block abuse of our forms. It stays in that mailbox for as long as the inquiry itself is retained.
${shared}`
...
- **Contact inquiries**, your name, email address, and optionally your phone number and company, plus your subject and message.
...
- **To respond to your inquiry.** This is the primary purpose. Without your contact details we cannot send you a quotation or answer your question.
...
Our lawful bases are: performance of a contract (or steps taken at your request before entering one), your consent (newsletter), our legitimate interests (protecting the site from abuse, responding to business inquiries), and compliance with legal obligations.
...
- **Quotation requests and inquiries**, retained for the duration of the commercial relationship and for **seven years** afterwards, to satisfy the record-keeping obligations attached to certified steel supply and any warranty period.
...
- Access to inquiry data is restricted to staff who need it to do their job.
