 ...
 *
 * Lucide dropped brand icons from its set, and pulling in a second icon package
 * for four glyphs is not worth the bytes. These are drawn to the same 24×24 grid
