...
export const products: Product[] = [
  {
    ...
    downloads: [
      ...
      {
        label: 'Mill Certificate Sample',
        description: 'Example EN 10204 3.1 certificate issued with every delivery.',
        size: '380 KB',
        format: 'PDF',
        href: '/downloads/epoxa-mill-certificate-sample.pdf',
      },
    ],
  ...
  },
  {
    ...
    downloads: [
      ...
      {
        label: 'Beam Sizing Worksheet',
        description: 'Spreadsheet for preliminary span and load checks.',
        size: '240 KB',
        format: 'XLSX',
        href: '/downloads/epoxa-beam-sizing.xlsx',
      },
    ],
  ...
  },
  {
    ...
    downloads: [
      ...
      {
        label: 'Profiling File Template',
        description: 'DXF layer conventions we use for nesting and cut paths.',
        size: '120 KB',
        format: 'DWG',
        href: '/downloads/epoxa-profiling-template.dwg',
      },
    ],
  ...
  },
  {
    ...
    downloads: [
      ...
      {
        label: 'Bar Bending Schedule Template',
        description: 'Spreadsheet template matching our production import format.',
        size: '180 KB',
        format: 'XLSX',
        href: '/downloads/epoxa-bbs-template.xlsx',
      },
    ],
  ...
  },
  {
    ...
    downloads: [
      ...
      {
        label: 'Welding Procedure Index',
        description: 'Qualified WPS register by material, thickness and position.',
        size: '1.3 MB',
        format: 'PDF',
        href: '/downloads/epoxa-wps-index.pdf',
      },
    ],
